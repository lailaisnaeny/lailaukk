                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <i id="togglePasswordBaruConfirmation" class="fas fa-eye" style="cursor: pointer;"></i>
                                </span>
                            </div>
                        </div>
                    </div>
                    <script>
                        document.getElementById('togglePasswordBaruConfirmation').addEventListener('click', function() {
                            var passwordInput = document.querySelector('input[name="password_baru_confirmation"]');
                            var icon = document.getElementById('togglePasswordBaruConfirmation');
